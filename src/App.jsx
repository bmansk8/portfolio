    ...
    <div className="App">
      ...
      <div className='row' id='Code'>
        ...
        <div className='col'>
          ...
          <p>If you want to see some of my completed projects click Check them out below.
      ...
      <div className='row' id='Music'>
        ...
        <div className='col'>
          ...
          <p>I am also a musician. Click <a rel='noopener noreferrer' target='_blank' href='https://soundcloud.com/bmansk14-brock'>here</a> to see all of my music.
          Musicians also make great programmers <FontAwesomeIcon icon={faSmileWink} /> </p>
        </div>
        <div className='col'>

        <iframe title='MorningDew' width="500px" height="166" scrolling="no" frameBorder="no" allow="autoplay"
        ...
        <iframe title='KeepHangingOn' width="500px" height="166" scrolling="no" frameBorder="no" allow="autoplay"
        ...
        <iframe title='ContrayMotionSynthRemix' width="500px" height="166" scrolling="no" frameBorder="no" allow="autoplay"
        ...
        <iframe title='ContraryMotion' width="500px" height="166" scrolling="no" frameBorder="no" allow="autoplay"
